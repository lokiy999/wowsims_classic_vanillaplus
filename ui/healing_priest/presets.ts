...
// Placeholder: the shadow priest pre-raid set until a healing set is made.
export const GearPlaceholder = PresetUtils.makePresetGear('Placeholder (shadow pre-raid)', PlaceholderGear);
