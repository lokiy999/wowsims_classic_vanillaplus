...
var SpellIconoverrides = []*proto.IconData{
	...
	// Custom server enchants (synthetic 900xxx ids, text from CSV's/VPlusItemDB.lua)
	{Id: 900101, Name: "Enchant Gloves - Nature Power", Icon: "spell_holy_greaterheal", Tooltip: `<b class="whtt-name">Enchant Gloves - Nature Power</b><br /><div class="q">Permanently enchant gloves to increase the nature damage done by spells and abilities by 20.</div>`},
	{Id: 900102, Name: "Enchant 2H Weapon - Savagery", Icon: "spell_holy_greaterheal", Tooltip: `<b class="whtt-name">Enchant 2H Weapon - Savagery</b><br /><div class="q">Permanently enchant a two-handed weapon to ignore 250 of your enemy's armor.</div>`},
	{Id: 900103, Name: "Enchant Weapon - Spellblasting", Icon: "spell_holy_greaterheal", Tooltip: `<b class="whtt-name">Enchant Weapon - Spellblasting</b><br /><div class="q">Permanently enchant a weapon to improve your chance to get a critical strike with spells by 1%.</div>`},
	{Id: 900210, Name: "Greater Arcanum of Accuracy", Icon: "inv_misc_gem_02", Tooltip: `<b class="whtt-name">Greater Arcanum of Accuracy</b><br /><div class="q">Permanently adds to a shoulder slot item increased hit chance for all attacks and spells by 1%.</div>`},
	{Id: 900211, Name: "Greater Arcanum of Concentration", Icon: "inv_misc_gem_02", Tooltip: `<b class="whtt-name">Greater Arcanum of Concentration</b><br /><div class="q">Permanently adds to a shoulder slot item increased Health and Mana regeneration by 10 per 5 sec.</div>`},
	{Id: 900212, Name: "Greater Arcanum of Avoidance", Icon: "inv_misc_gem_02", Tooltip: `<b class="whtt-name">Greater Arcanum of Avoidance</b><br /><div class="q">Permanently adds to a shoulder slot item reduced the chance you are hit by attacks and spells by 1%.</div>`},
	{Id: 900202, Name: "Sigil of Sturdiness: Belt", Icon: "inv_misc_armorkit_18", Tooltip: `<b class="whtt-name">Sigil of Sturdiness: Belt</b><br /><div class="q">Permanently enchants belt to give +5 Stamina.</div>`},
	{Id: 900204, Name: "Sigil of Power: Gloves", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Gloves</b><br /><div class="q">Permanently enchant gloves to grant 20 Attack Power.</div>`},
	{Id: 900205, Name: "Sigil of Power: Gloves", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Gloves</b><br /><div class="q">Permanently enchant gloves to grant 12 spell damage and healing.</div>`},
	{Id: 900206, Name: "Sigil of Power: Bracer", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Bracer</b><br /><div class="q">Permanently enchant bracers to grant 20 Attack Power.</div>`},
	{Id: 900207, Name: "Sigil of Power: Bracer", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Bracer</b><br /><div class="q">Permanently enchant bracers to grant 12 spell damage and healing.</div>`},
	{Id: 900208, Name: "Sigil of Power: Chest", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Chest</b><br /><div class="q">Permanently enchant a piece of chest to grant 30 Attack Power.</div>`},
	{Id: 900209, Name: "Sigil of Power: Chest", Icon: "spell_shadow_deathpact", Tooltip: `<b class="whtt-name">Sigil of Power: Chest</b><br /><div class="q">Permanently enchant a piece of chest to grant 18 spell damage and healing.</div>`},
}
