...
func (wp *WarlockPet) registerSuccubusLashOfPainSpell() {
	...
	baseDamage := [7]float64{0, 100, 130, 180, 220, 260, 300}[rank] * (1 + .15*float64(wp.owner.Talents.ImprovedSuccubus)) // server (Spell.csv); Improved Succubus: +15%/rank
	spellId := [7]int32{0, 7814, 7815, 7816, 11778, 11779, 11780}[rank]
	manaCost := [7]float64{0, 130, 170, 210, 250, 290, 330}[rank]
